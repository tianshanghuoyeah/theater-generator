...
(function() {
    ...
    async function buildPromptByFloor(floorCount) {
        ...
        return (
'你是一个小剧场生成创作者，运用HTML 或内联 CSS 来美化和排版小剧场的内容。' +          '- 题材不限语言简体中文，发挥想象力从例如平行世界、校园风、古风、玄幻、欧美贵族等各大热门题材中选择\n' +
...
— 输出为可直接渲染的HTML片段，禁止解释文字与HTML代码头部围栏。`,
                  ...
                  <div style="display:flex;gap:6px;align-items:center;">
                    <div style="flex:1;position:relative;">
                      <select id="theater-preset" style="width:100%;padding:8px 12px;border:2px solid #e1e5e9;border-radius:8px;background:#fff;font-size:14px;color:#333;transition:all 0.2s ease;outline:none;" onfocus="this.style.borderColor='#4a90e2'" onblur="this.style.borderColor='#e1e5e9'">
                        ...
                        <option value="题材不限语言简体中文，发挥想象力从例如平行世界、校园风、古风、玄幻、欧美贵族等各大热门题材中选择，用小红书、论坛、朋友圈、聊天、帖子、b站、pornhub、书信、知乎、抖音等多种趣味形式，鼓励增加趣味互动性的点击功能，*禁止生成正文，只生成小剧场*。">小火默认小剧场预设</option>
                        ${customPresetOptions}
                      </select>
                    </div>
      ...
      deletePreset() {
        ...
        const builtinPresets = [
          '题材不限语言简体中文，发挥想象力从例如平行世界、校园风、古风、玄幻、欧美贵族等各大热门题材中选择，用小红书、论坛、朋友圈、聊天、帖子、b站、pornhub、书信、知乎、抖音等多种趣味形式，鼓励增加趣味互动性的点击功能，*禁止生成正文，只生成小剧场*。'
        ];
      ...
      showPresetSearchModal(moduleType) {
        ...
        const builtinPresets = moduleType === 'theater' ? [
          {
            name: '小火默认小剧场预设',
            content: '题材不限语言简体中文，发挥想象力从例如平行世界、校园风、古风、玄幻、欧美贵族等各大热门题材中选择，用小红书、论坛、朋友圈、聊天、帖子、b站、pornhub、书信、知乎、抖音等多种趣味形式，鼓励增加趣味互动性的点击功能，*禁止生成正文，只生成小剧场*。'
          }
        ] : [
          {
            name: '小火默认日记预设',
